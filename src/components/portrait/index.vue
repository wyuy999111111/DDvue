...
export default {
  ...
  watch: {
    "$store.state.flag"() {
      if (this.$store.state.flag) {
        setTimeout(() => {
          document.getElementsByClassName("open arrow")[0].style.paddingLeft =
            "140px";
          document.getElementsByClassName("open arrow")[0].style.paddingTop =
            "15px";
          for (
            let i = 0;
            i < document.getElementsByClassName("el-submenu__title").length;
            i++
          ) {
            document.getElementsByClassName("el-submenu__title")[
              i
            ].style.width = "180px";
            document.getElementsByClassName("el-submenu__title")[
              i
          ...
          for (
            let i = 0;
            i < document.getElementsByClassName("el-menu-item").length;
            i++
          ) {
            document.getElementsByClassName("el-menu-item")[i].style.width =
              "180px";
            document.getElementsByClassName("el-menu-item")[i].style.height =
              "35px";
            document.getElementsByClassName("el-menu-item")[
              i
            ...
            document.getElementsByClassName("el-menu-item")[i].style.textAlign =
              "center";
            document.getElementsByClassName("el-menu-item")[i].style.fontSize =
              "14px";
          }
          for (
            let i = 0;
            i <
            document.getElementsByClassName("el-menu-item-group__title").length;
            i++
          ) {
            document.getElementsByClassName("el-menu-item-group__title")[
              i
            ].style.paddingLeft = "80px!important";
          }
        ...
        setTimeout(() => {
          ...
          document.getElementsByClassName("el-menu--collapse")[0].style.width =
            "35px";
          for (
            let i = 0;
            i < document.getElementsByClassName("el-menu-item").length;
      ...
      this.$nextTick(() => {
        setTimeout(() => {
          ...
          document.getElementsByClassName("close")[0].style.marginBottom =
            "5px";
          ...
          document.getElementsByClassName("el-submenu__title")[0].style.height =
            "40px";
          document.getElementsByClassName(
            "el-submenu__title"
          )[0].style.paddingTop = "2px";
          document.getElementsByClassName("el-submenu__title")[1].style.height =
            "40px";
          document.getElementsByClassName(
            "el-submenu__title"
          )[1].style.paddingTop = "2px";
          document.getElementsByClassName("el-submenu__title")[2].style.height =
            "40px";
          document.getElementsByClassName(
            "el-submenu__title"
          )[2].style.paddingTop = "2px";
          document.getElementsByClassName("el-submenu__title")[3].style.height =
            "40px";
          document.getElementsByClassName(
            "el-submenu__title"
          )[3].style.paddingTop = "2px";
          document.getElementsByClassName("el-submenu__title")[4].style.height =
            "40px";
          document.getElementsByClassName(
            "el-submenu__title"
          )[4].style.paddingTop = "2px";
          document.getElementsByClassName("el-submenu__title")[5].style.height =
            "40px";
          document.getElementsByClassName(
            "el-submenu__title"
          )[5].style.paddingTop = "2px";
    ...
    loginTop: {
      handler(val, oldVal) {
        ...
        if (this.GetWindowInfo.width === 1366) {
          ...
          if (val >= this.$refs.special.$el.clientHeight + 3800) {
            this.activeTop = "7";
          } else {
            if (val === 0) {
              this.activeTop = "1";
        ...
        if (this.GetWindowInfo.width === 1600) {
          ...
          if (val >= this.$refs.special.$el.clientHeight + 3130) {
            this.activeTop = "7";
          } else {
            if (val === 0) {
              this.activeTop = "1";
        ...
        if (this.GetWindowInfo.width === 1920) {
          ...
          if (val >= this.$refs.special.$el.clientHeight + 4300) {
            this.activeTop = "7";
          } else {
            if (val === 0) {
              this.activeTop = "1";
  ...
  created() {
    setTimeout(() => {
      document.getElementsByClassName("el-aside little")[0].style.width =
        "40px";
    }, 100);
    const baseSize = 16;
    function setRem() {
    ...
    if (this.$store.state.flag) {
      setTimeout(() => {
        ...
        for (
          ...
          document.getElementsByClassName("el-submenu__title")[i].style.width =
            "180px";
          document.getElementsByClassName("el-submenu__title")[
            i
          ].style.display = "flex";
        ...
        for (
          ...
          document.getElementsByClassName("el-menu-item")[i].style.height =
            "35px";
          document.getElementsByClassName("el-menu-item")[i].style.paddingLeft =
            "55px";
          document.getElementsByClassName("el-menu-item")[
            i
          ].style.paddingRight = "45px";
          document.getElementsByClassName("el-menu-item")[i].style.lineHeight =
            "35px";
          document.getElementsByClassName("el-menu-item")[i].style.textAlign =
            "center";
          document.getElementsByClassName("el-menu-item")[i].style.fontSize =
  ...
  methods: {
    ...
    topTitleOne() {
      if (this.GetWindowInfo.width === 1366) {
        this.$refs.login.scrollTop =
          this.$refs.information.$el.clientHeight - 870;
      } else if (this.GetWindowInfo.width === 1600) {
        this.$refs.login.scrollTop =
          this.$refs.information.$el.clientHeight - 850;
      } else {
        this.$refs.login.scrollTop =
          this.$refs.information.$el.clientHeight - 870;
      }
    ...
    topTitletwo() {
      if (this.GetWindowInfo.width === 1366) {
        this.$refs.login.scrollTop =
          this.$refs.assessment.$el.clientHeight + 162;
      } else if (this.GetWindowInfo.width === 1600) {
        this.$refs.login.scrollTop =
          this.$refs.assessment.$el.clientHeight + 192;
      } else {
        this.$refs.login.scrollTop =
          this.$refs.assessment.$el.clientHeight + 232;
      }
      console.log(this.$refs.assessment);
      this.activeTop = "2";
    },
    topTitleThree() {
      if (this.GetWindowInfo.width === 1366) {
    ...
    topTitleFour() {
      if (this.GetWindowInfo.width === 1366) {
        this.$refs.login.scrollTop =
          this.$refs.customer.$el.clientHeight + 1245;
      } else if (this.GetWindowInfo.width === 1600) {
        this.$refs.login.scrollTop =
          this.$refs.customer.$el.clientHeight + 1460;
      } else {
        this.$refs.login.scrollTop =
          this.$refs.customer.$el.clientHeight + 1745;
      }
    ...
    topTitleFive() {
      if (this.GetWindowInfo.width === 1366) {
        this.$refs.login.scrollTop =
          this.$refs.insurance.$el.clientHeight + 1865;
      } else if (this.GetWindowInfo.width === 1600) {
        this.$refs.login.scrollTop =
          this.$refs.insurance.$el.clientHeight + 2190;
      } else {
        this.$refs.login.scrollTop =
          this.$refs.insurance.$el.clientHeight + 2625;
      }
    ...
    topTitleSix() {
      if (this.GetWindowInfo.width === 1366) {
        this.$refs.login.scrollTop =
          this.$refs.behaviors.$el.clientHeight + 2880;
      } else if (this.GetWindowInfo.width === 1600) {
        this.$refs.login.scrollTop =
          this.$refs.behaviors.$el.clientHeight + 3380;
      } else {
        this.$refs.login.scrollTop =
          this.$refs.behaviors.$el.clientHeight + 4050;
      }
    ...
    topTitleSeven() {
      if (this.GetWindowInfo.width === 1366) {
        this.$refs.login.scrollTop = this.$refs.special.$el.clientHeight + 3130;
      } else if (this.GetWindowInfo.width === 1600) {
        this.$refs.login.scrollTop = this.$refs.special.$el.clientHeight + 3610;
      } else {
        this.$refs.login.scrollTop = this.$refs.special.$el.clientHeight + 4300;
      }
      console.log(this.$refs.special);
      this.activeTop = "7";
    },
    goBack() {
      ...
      if (this.$route.query.historySec === "/groupManagement/see") {
        this.$router.push(
          this.$route.query.historySec +
            "?groupId=" +
            this.$route.query.groupId +
            "&history=" +
            this.$route.query.history +
            "&firId=" +
            this.$route.query.firId +
            "&share=" +
