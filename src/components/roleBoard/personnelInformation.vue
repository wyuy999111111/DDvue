<template>
  <div id="personnelInformation">
    ...
    <div class="personCards">
      ...
      <PersonCard :params='paramsf' v-if="$store.state.findRole.channelResult !== 'C0000017'" />
      <PersonCard :params='paramsg' v-if="$store.state.findRole.channelResult !== 'C0000017'" />
      <PersonCard :params='paramsh' />
      <PersonCard :params='paramsi' />
      <PersonCard :params='paramsj' />

      <PersonCard :params='paramsl' v-if="$store.state.findRole.channelResult === 'C0000017'" />
      <PersonCard :params='paramsm' v-if="$store.state.findRole.channelResult === 'C0000017'" />
      <PersonCard :params='paramsn' v-if="$store.state.findRole.channelResult === 'C0000017'" />

    </div>
    <div class="titleBgp">队伍健康度</div>
    <div class="healthy">
      <div class="healthyChilda">
        <PersonHealthyTop :params='healthyParamsA' />
        <PersonHealthyTopB :params='healthyParamsB'/>
        <PersonHealthyTopC :params='healthyParamsC' class='marginTop' :status='status'/>
      ...
      <div class="healthyChildb">
        ...
        <div class="cardB">
          ...
          <div class="trend trendTop">
            ...
            <img class="imgS" v-if="dataSourse.cprlastMonthFalg === 'RISE'" src="../../assets/logo/up.png" />
            <img class="imgS" v-if="dataSourse.cprlastMonthFalg === 'DECLINE'" src="../../assets/logo/down.png" />
            <img class="imgB" v-if="dataSourse.cprlastMonthFalg === 'EQULE'" src="../../assets/logo/hx.png" />
            </div>
            <div class="trendNum"><div class="trendP" v-if="dataSourse.cprlastMonth != -1">{{dataSourse.cprlastMonth}}</div></div>
          </div>
          <div class="trend">
            <div class="trendA">
            <div class="trendText">比年初</div>
            <img class="imgS" v-if="dataSourse.cprbeginYearFalg === 'RISE'" src="../../assets/logo/up.png" />
            <img class="imgS" v-if="dataSourse.cprbeginYearFalg === 'DECLINE'" src="../../assets/logo/down.png" />
            <img class="imgB" v-if="dataSourse.cprbeginYearFalg === 'EQULE'" src="../../assets/logo/hx.png" />
            </div>
            <div class="trendNum"><div v-if="dataSourse.cprbeginYear != -1">{{dataSourse.cprbeginYear}}</div></div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  components: {
    PointerTitle, PersonCardBig, PersonCard, PersonHealthyTop, PersonHealthyTopB, PersonHealthyTopC, PersonHealthyTopD
  },
  data () {
    return {
      status: false,
  ...
  methods: {
    getData () {
      ...
      PersonnelInformation(params).then((res) => {
        ...
        this.healthyParamsA.numA = data.newGenerationRate.adultsNum
        this.healthyParamsA.numB = data.newGenerationRate.reachNum
        this.healthyParamsA.textNuma = data.newGenerationRate.notTemporaryReachNum
        this.healthyParamsA.textNumb = data.newGenerationRate.temporaryReachNum
        this.healthyParamsA.proportion = data.newGenerationRate.fertilityRate
        this.healthyParamsA.rightNum = data.newGenerationRate.fertilityLm
        this.healthyParamsA.peopleNum = data.newGenerationRate.reachNum
        this.healthyParamsA.rightType = data.newGenerationRate.fertilityLmFalg
