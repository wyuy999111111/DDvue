<template>
  <div id="strategyUddate" ref="132">
    <div class="strategyTitle">
      <img src="../../assets/logo/title.png" />策略修改
    </div>
    <div class="content">
        ...
        <el-form :gutter="24" label-width="120px" class="form">
          ...
          <el-col :span="12">
            <el-form-item label="发送方式：">
              <el-select
                v-model="$store.state.strategy.sendType"
                :disabled="disabled"
              >
                <el-option
                  label="属性方式"
      ...
      <div class="btnList">
        <div v-if="$store.state.strategy.strategyStatus === '1'">
          <el-button :loading="loading" @click="strategyUpdate(1)"
            >提交审核</el-button
          >
          <el-button :loading="loading" @click="strategyUpdate(5)"
            >取消</el-button
          >
        ...
        <div v-if="$store.state.strategy.strategyStatus === '4'">
          <el-button :loading="loading" @click="updateJobStatus(3)"
            >暂停</el-button
          >
          <el-button :loading="loading" @click="updateJobStatus(6)"
            >强制结束</el-button
          >
          <el-button @click="goBack">返回</el-button>
        </div>
        ...
        <div v-if="$store.state.strategy.strategyStatus === '3'">
          <el-button :loading="loading" @click="strategyUpdate(1)"
            >提交审核</el-button
          >
          <el-button :loading="loading" @click="updateJobStatus(4)"
            >恢复</el-button
          >
          <el-button :loading="loading" @click="updateJobStatus(6)"
            >强制结束</el-button
